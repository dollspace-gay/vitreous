...
### Fixed
- Fix double-typed text, persist interactive state, complete style page (#184)
- Fix Signal disposed panic — router signals destroyed by scope cleanup (#182)
- Fix navigation, improve kitchen sink appearance, tune text positioning (#181)
